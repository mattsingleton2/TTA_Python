...
#   Python Ver: 3.10.4
#
#   Author: Matthew Singleton, under tutelage of Daniel Christie @ The Tech Academy
#
#   Purpose: Phonebook Demo to demonstrate OOP, Tkinter GUI module, Tkinter parent and Child Relationships
#
#
#   Tested OS: This code was written to work with Windows 10 & 11
...
#   Time to set up our gui.

def load_gui(self):
    
    #   Labels first...
    #   Instantiate the label first, then paint it on the grid.
    ...
    #   Fields next.
    #   Much the same. Instantiate the field, paint it on the grid.
    ...
    #   Let's make a listbox with a scrollbar
    ...
    #   A little call to our phonebook_func script
